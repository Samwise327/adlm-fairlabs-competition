...
fairlabs_data_tested <- fairlabs_data %>% filter(tested10 == 1)
fairlabs_data_before <- fairlabs_data %>% filter(BA_intervention == "Before")
fairlabs_data_tested_before <- fairlabs_data_tested %>% 
  filter(BA_intervention == "Before")
fairlabs_data_after <- fairlabs_data %>% filter(BA_intervention == "After")
...
month_count_combined <- replace(month_count_combined,
                                is.na(month_count_combined),0)
...
#==============================================================================
#                         Indication Sensitivity and Specificity
#==============================================================================
